 ...
 */
final class Version20190904113606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category1_id INT NOT NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD987AE85A FOREIGN KEY (category1_id) REFERENCES category1 (id)');
        $this->addSql('CREATE INDEX IDX_D34A04AD987AE85A ON product (category1_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql(' ');
        $this->addSql('ALTER TABLE product DROP category1_id');
    }
}
